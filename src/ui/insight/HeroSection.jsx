...
Browse View Reports      </button>
      <button className="px-8 py-3 border border-sky-500 text-sky-500 font-semibold rounded-lg hover:bg-sky-600 transition-colors duration-200 shadow-sm">
View Archive      </button>
