  ...
  <div className="max-w-4xl mx-auto">
    <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl overflow-hidden shadow-2xl">
      <div className="grid md:grid-cols-2 gap-0">
        {/* Left side skeleton */}
        <div className="p-12 flex flex-col justify-center space-y-6 animate-pulse">
        ...
        {/* Right side skeleton */}
        <div className="bg-gradient-to-br from-teal-600/20 to-blue-600/20 p-12 flex items-center justify-center animate-pulse">
  ...
  return (
    <section className="py-20 text-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="group relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl overflow-hidden shadow-2xl hover:shadow-teal-500/20 transition-all duration-500">
            <div className="grid md:grid-cols-2 gap-0">
              {/* Left side - Content */}
              ...
              <div className="bg-gradient-to-br from-teal-600/30 to-blue-600/30 p-12 flex items-center justify-center relative overflow-hidden">
                {/* Decorative circles */}
